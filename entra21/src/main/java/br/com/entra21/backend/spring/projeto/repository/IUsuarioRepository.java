...
public interface IUsuarioRepository extends JpaRepository<Usuario, Integer> {
	...
	// No controller seria chamado esse método que traria todos esses usuários
	// Percorrer a lista procurando quem é 'maior de idade'
	// Cada item que atende ao critério, seria filtrado em uma nova lista
	
	// Tudo isso é substituído por uma busca que traz exatamente os dados que eu preciso
